...
<tr>
<td width="13%"><strong>Languages</strong></td>
<td>
...
AI-powered predictive maintenance using NASA C-MAPSS turbofan data to estimate Remaining Useful Life and support risk-based maintenance decisions.
...
Full-stack application for creating messages and scheduling them for future delivery with persistent storage, background scheduling, and automated email delivery.
